...
import {updateProduct } from '../../../../Redux/ActionReducer/productReducer';
      ...
      useEffect(()=>{
        ...
        return (
            <div className=" sm:w-44 md:w-full  bg-white flex flex-col justify-center  items-center  bg-opacity-30 px-10">
                <Header compo={"Update Product"}/>
                <Formik 
                    initialValues={{name:data.name,image:data.image,price:data.price, category:data.category,detail:data.detail,quantity:data.quantity}}
